...
module jesd204_tx #(
  ...
  parameter IN_DATA_PATH_WIDTH = LINK_MODE[1] ? 8 : 4,
  ...
  input [IN_DATA_PATH_WIDTH*8*NUM_LANES-1:0] tx_data,
  output tx_ready,
...
jesd204_lmfc #(
  .LINK_MODE(LINK_MODE),
  .DATA_PATH_WIDTH(IN_DATA_PATH_WIDTH)
) i_device_lmfc (
  .clk(device_clk),
  .reset(device_reset),
...
jesd204_tx_gearbox #(
  .IN_DATA_PATH_WIDTH(IN_DATA_PATH_WIDTH),
